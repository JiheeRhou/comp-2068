...
import { index as productIndex, show as productShow } from "../controllers/ProductsController.js";
...
router.get("/products", applicationAuthenticate, productIndex);
router.get("/products/:id", applicationAuthenticate, productShow);
